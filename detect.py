...
from com_ineuron_apparel.com_ineuron_utils import utils

class Detector():

    def __init__(self, filename):
        self.weights="./com_ineuron_apparel/predictor_yolo_detector/best.pt"  # model.pt path(s)
        self.source="./com_ineuron_apparel/predictor_yolo_detector/inference/images/"+filename  # file/dir/URL/glob, 0 for webcam
        ...
        self.project="./com_ineuron_apparel/predictor_yolo_detector/inference/output" # save results to project/name
    ...
    def detect_action(self):
        with torch.no_grad():
            self.run()
        bgr_image = cv2.imread("./com_ineuron_apparel/predictor_yolo_detector/inference/output/output_image.jpg")
        cv2.imwrite('predicted_output_image.jpg', bgr_image)
        opencodedbase64 = utils.encodeImageIntoBase64('./com_ineuron_apparel/predictor_yolo_detector/inference/output/output_image.jpg')
